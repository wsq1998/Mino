...
const LANG = {
  zh: {
    ...
    'snippet.remove': '删除',
    'snippet.saved': '已保存',
    'snippet.tooLong': '内容不能超过 2000 字符',
    // 分屏
    'split.title': '窗口分屏',
    'split.left': '左半屏',
    'split.right': '右半屏',
  ...
  en: {
    ...
    'snippet.empty': 'No snippets yet',
    'snippet.name': 'Name',
    'snippet.text': 'Text',
    'snippet.insert': 'Insert',
    'snippet.remove': 'Delete',
    'snippet.saved': 'Saved',
    'snippet.tooLong': 'Text cannot exceed 2000 characters',
    ...
    'settings.recurring': 'Recurring Reminders',
